...
class NestSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->createNodejsNest(array_get($items, 'Nodejs'));
    }
...
/**
     * Create Rust nest to be used later on.
     *
     * @throws \Pterodactyl\Exceptions\Model\DataValidationException
     */
    ...
    /**
     * Create Nodejs nest to be used later on.
     *
     * @throws \Pterodactyl\Exceptions\Model\DataValidationException
     */
    private function createNodejsNest(array $nest = null)
    {
        if (is_null($nest)) {
            $this->creationService->handle([
                'name' => 'Nodejs',
                'description' => 'Node.js applications including WhatsApp and Telegram bots.',
            ], 'support@pterodactyl.io');
        }
    }
}
