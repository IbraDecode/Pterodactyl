...
/*
|--------------------------------------------------------------------------
| Protection Controller Routes
|--------------------------------------------------------------------------
|
| Endpoint: /admin/protection
|
*/
Route::group(['prefix' => 'protection'], function () {
    Route::get('/', [Admin\ProtectionController::class, 'index'])->name('admin.protection.index');
    Route::patch('/', [Admin\ProtectionController::class, 'update'])->name('admin.protection.update');
    Route::post('/apply', [Admin\ProtectionController::class, 'applyProtection'])->name('admin.protection.apply');
});
